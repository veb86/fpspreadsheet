...
begin
  ...
  try
    ...
    ser.Fill.Pattern := ch.FillPatterns.AddPattern('Hatched', fpsDiagDownNarrow, ChartColor(scWhite), ChartColor(scRed));
    ...
    ser.Fill.Pattern := ch.FillPatterns.AddPattern('Forward', fpsDiagUpThin, ChartColor(scYellow), ChartColor(scBlue));
    ser.Fill.Style := cfsPattern;
